        ...
        <div id="wd-people-table">
            <Table striped>
                ...
                <tbody>
                    ...
                    <td className="wd-total-activity">10:21:40</td></tr>
                    ...
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2016-10-01</td>
                    <td className="wd-total-activity">06:21:32</td></tr>
                    ...
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2017-10-01</td>
                    <td className="wd-total-activity">10:21:10</td></tr>
                    ...
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2016-10-01</td>
                    <td className="wd-total-activity">07:21:10</td></tr>
                </tbody>
            </Table>
        </div> 
);}
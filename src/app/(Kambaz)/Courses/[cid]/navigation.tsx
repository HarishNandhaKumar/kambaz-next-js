...
return (
    <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0">
        ...
        <Link href="/Courses/1234/Assignments" id="wd-course-quizzes-link" className="list-group-item text-danger border-0">Assignments</Link>
        <Link href="/Courses/1234/Quizzes" id="wd-course-assignments-link" className="list-group-item text-danger border-0">Quizzes</Link>

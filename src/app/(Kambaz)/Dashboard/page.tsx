            ...
            <div id="wd-dashboard-courses">
                ...
                <div className="wd-dashboard-course">
                    <Link href="/Courses/1236" className="wd-dashboard-course-link">
                        <Image src="/images/aicourse.jpg" width={200} height={150} alt="AI Course" />
                        <div>
                            <h5> CS1236 AI </h5>
                            <p className="wd-dashboard-course-title">
                ...
                <div className="wd-dashboard-course">
                    <Link href="/Courses/1237" className="wd-dashboard-course-link">
                        <Image src="/images/oop.jpg" width={200} height={150} alt="OOP Course" />
                        <div>
                            <h5> CS1237 OOP </h5>
                            <p className="wd-dashboard-course-title">
                ...
                <div className="wd-dashboard-course">
                    <Link href="/Courses/1238" className="wd-dashboard-course-link">
                        <Image src="/images/operatingsystem.jpg" width={200} height={150} alt="Operating Systems Course" />
                        <div>
                            <h5> CS1238 OPsys </h5>
                            <p className="wd-dashboard-course-title">
                            Operating Systems
                ...
                <div className="wd-dashboard-course">
                    <Link href="/Courses/1239" className="wd-dashboard-course-link">
                        <Image src="/images/dbms.jpg" width={200} height={150} alt="dbms Course" />
                        <div>
                            <h5> CS1239 DBMS </h5>
                            <p className="wd-dashboard-course-title">
                ...
                <div className="wd-dashboard-course">
                    <Link href="/Courses/1240" className="wd-dashboard-course-link">
                        <Image src="/images/networks.png" width={200} height={150} alt="networks Course" />
                        <div>
                            <h5> CS1240 CompNet </h5>
                            <p className="wd-dashboard-course-title">
                              Computer Network
                            </p>
                            <button> Go </button>

        ...
        <div id="wd-dashboard">
            ...
            <h5>New Course
                <button className="btn btn-primary float-end"
                    id="wd-add-new-course-click" onClick={() => dispatch(addNewCourse(course))}> 
                    Add 
                </button>
            ...
            <div id="wd-dashboard-courses">
                <Row xs={1} md={5} className="g-4">
                    {courses.filter((course) => (currentUser as any)?._id && enrollments.some((enrollment) => enrollment.user === (currentUser as any)._id && enrollment.course === course._id))
                    .map((course) => (
                                ...
                                <Link href={`/Courses/${course._id}/Home`} className="wd-dashboard-course-link text-decoration-none text-dark">
                                    ...
                                    <CardBody>
                                        ...
                                        <button onClick={(event) => {event.preventDefault(); dispatch(deleteCourse(course._id));}} 
                                            className="btn btn-danger float-end" id="wd-delete-course-click">Delete
                                        </button>
